...
function validate(){
   ...
   var birth = document.getElementById("m_birth").value;
 ...
 <div>
   <!-- Main content -->
    <section class="content container">
      <form role="form" name="f" method="post" action="${contextPath}/board/changeId" onsubmit="return validate();">
        ...
        <div class="col-lg-4 col-md-6">
           <div class="service-item bg-light rounded d-flex flex-column align-items-left justify-content-center" style="width:560;height:350;">
            ...
            <div class="box-group">
               <label>이   름</label>
               <input type='text' id='m_name' name='m_name' style="width:28%; margin-left:80px; border:none;">
            </div>
            
            <!-- 생년월일 --><br>
            <div class="box-group">
               <label>주민등록번호</label>
               <input type="text" id="m_birth" name="m_birth" minlength="6" maxlength="6" style="width:150px; height:28;margin-left:20px;border:none;"> - 
