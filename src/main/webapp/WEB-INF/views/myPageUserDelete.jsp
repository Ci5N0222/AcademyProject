...
<!-- title end-->
   ...
   <section class="content container" style="width:600px; height:100px;padding-left:50px;">
   <form role="form" name="f" method="post" onclick="validation();">
         <div class="box" >
               ...
               <div class="form-group"style="height:30%">
                  <label><h5> 아 이 디 </h5></label>  <input type="text" name="m_id" id = "m_id"
                   value= "${user.m_id}" style="width:50%;height:35px;color:black;background-color:#E6E6E6;margin-left:50px;text-align:center;border:none;margin-bottom:10px;" readonly="readonly" />
                    
               </div>
                <div class="form-group"style="height:30%">
                  <label><h5> 비밀번호 </h5></label>  <input type="password" name="m_pw" id="m_pw"
                   style="width:50%;height:35px;background-color:#FFFFFF;margin-left:40px;text-align:center;border:none;"/>
                   <input type="hidden" id="pw2" name="pw2" value="${user.m_pw}">
               </div>
