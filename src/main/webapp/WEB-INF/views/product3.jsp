            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    <div class="bg-primary rounded h-100 d-flex align-items-center p-5">                    
                            ...
                            <div class="row g-3">
                            <div>
                        <input type="hidden" id="p_cd" name="p_cd" value="p3" style="width:22%;"readonly>
                        ...
                        <input type="hidden" id="p_cd_name" name="p_cd_name" value="GS25 편의점 모바일 교환권 1,000p" style="width:22%;"readonly>                       
                      </div>
                            <div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-6">
                ...
                <div class="col-lg-4">
                    <div class="team-item bg-light rounded overflow-hidden">
                        <div class="team-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="${contextPath}/resources/bootstrap/img/product2.png" alt="">
                            <div class="team-social">
