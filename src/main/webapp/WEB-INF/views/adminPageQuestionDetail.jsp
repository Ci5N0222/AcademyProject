   ...
   <div id="detail_wrap1" class="box" >
         <div id="detail_box2" class="box-body">  
            <div class="form-group" style="text-align:right">
               ...
               <label><h6>글상태 : ${board.q_end}　　</h6></label>
               <label><h6>${board.bd_dt}</h6></label>
            </div>
             <div class="form-group">
             <input type ="hidden" id= "bd_ste" name = "bd_ste" class="form-control">
          </div>   
          <div class="form-group">
            ...
            <div class="box-body"style="height:10%">
               <table>
                  ...
                  <tr>
                     ...
                     <td><input type="hidden" name="q_end" id="q_end" value="${board.q_end}"></td>
                  </tr>
               </table>  
            </div>
            <hr><p></p>
