      ...
      <form role="form" name="f" method="post" onsubmit="return validate();">
         <div class="box-body">
            <div class="col-lg-4 col-md-6" style="visibility: visible;">
               <div class="service-item bg-light rounded d-flex flex-column align-items-left justify-content-center" style="width:730;height:850;padding-left:100px;">
            ...
            <div class="box-group"> 
               ...
               <input type='hidden' id='idcheck1' name='idcheck1' class="form-control" value="중복확인이 완료되었습니다." style="color:green; width:200px;height:28px;border:none;font-size:0.8em;text-align:center;margin-left:115px;margin-top:8px;">    
            </div>
            ...
            <br><div class="box-group">
               ...
               <input type='hidden' id='enamecheck1' name='enamecheck1' class="form-control" value="중복확인이 완료되었습니다." style="color:green; width:200px;height:28px;border:none;font-size:0.8em;text-align:center;margin-left:115px;margin-top:8px;" >                     
            </div>
